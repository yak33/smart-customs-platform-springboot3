package com.smart.customs.system.monitor.aspect;
...
import com.smart.customs.infrastructure.annotation.RepeatSubmit;
...
public class OperationLogAspect {
     ...
     * 定义切入点
     */
    @Pointcut("execution(* com.smart.*.controller.*.*Controller.*(..))")
